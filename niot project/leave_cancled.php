  ...
  background-color: #f1f1f1;
    ...
    <body>
        ...
        <?php
           ...
           echo "<tr><th>Leave_Apply_ID</th><th>User_Name</th><th>Leave_Type</th><th>From_Date</th><th>To_Date</th><th>Total_Days</th><th>Reason</th><th>Status</th><th>Applied_Date</th><th>Rejected_ID</th></tr>";
           while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
           echo "<tr><td>" . $row['leave_apply_id'] . "</td><td>" . $row['user_name'] . "</td><td>" . $row['leave_type'] . "</td><td>" . $row['from_date'] . "</td><td>" . $row['to_date'] . "</td><td>" . $row['total_days'] . "</td><td>" . $row['reason'] . "</td><td>" . $row['status'] . "</td><td>" . $row['applied_date'] . "</td><td>" . $row['approv_id'] . "</td></tr>";  //$row['index'] the index here is a field name
           }
